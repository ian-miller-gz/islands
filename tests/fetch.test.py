...
Test.Summary = "A session fetches from a loopback origin (NETWORK::WEB, SR_NATIVE)"

REACH = '"http to 127.0.0.1"'

client = os.path.join(Test.TestDirectory, 'fetch.py')
